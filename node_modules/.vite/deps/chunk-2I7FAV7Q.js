...
async function sha512(msg) {
  ...
  const hash = import_crypto.default.createHash("sha512");
...
async function hmacSha256Sign(key, msg) {
  ...
  const hmac = import_crypto.default.createHmac("sha256", Buffer.from(key));
  hmac.update(msg);
...
//# sourceMappingURL=chunk-2I7FAV7Q.js.map
