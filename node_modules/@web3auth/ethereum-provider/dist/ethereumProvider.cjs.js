...
__webpack_require__.d(__webpack_exports__, {
  ...
  SN: () => (/* reexport */ validateTypedMessageParams)
});
...
var openlogin_jrpc_ = __webpack_require__(13);
...
;// CONCATENATED MODULE: ./src/providers/privateKeyProviders/TransactionFormatter/interfaces.ts
...
const validateTypedMessageParams = async (parameters, activeChainId) => {
  try {
    ...
    throw openlogin_jrpc_.rpcErrors.invalidInput({
      message: error === null || error === void 0 ? void 0 : error.message
    });
  }
};
;// CONCATENATED MODULE: ./src/providers/privateKeyProviders/TransactionFormatter/formatter.ts
...
function getProviderHandlers({
  ...
  return {
    ...
    processTransaction: async (txParams, _) => {
      ...
      if (!providerEngineProxy) throw openlogin_jrpc_.providerErrors.custom({
...
class EthereumPrivateKeyProvider extends base_provider_namespaceObject.BaseProvider {
  ...
  async enable() {
    if (!this.state.privateKey) throw openlogin_jrpc_.providerErrors.custom({
  ...
  async setupProvider(privKey) {
    ...
    const provider = (0,openlogin_jrpc_.providerFromEngine)(engine);
    this.updateProviderEngineProxy(provider);
    await txFormatter.init();
    await this.lookupNetwork();
  }
  async updateAccount(params) {
    if (!this._providerEngineProxy) throw openlogin_jrpc_.providerErrors.custom({
      message: "Provider is not initialized",
      code: 4902
    });
  ...
  async lookupNetwork() {
    ...
    if (!chainId) throw openlogin_jrpc_.rpcErrors.invalidParams("chainId is required while lookupNetwork");
    ...
    if (parseInt(chainId, 16) !== finalNetwork) throw openlogin_jrpc_.providerErrors.chainDisconnected(`Invalid network, net_version is: ${network}`);
...
/* harmony export */ });
/* harmony import */ var _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
...
function createEthMiddleware(providerHandlers) {
  ...
  const ethMiddleware = (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.mergeMiddleware)([(0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createScaffoldMiddleware)({
    eth_syncing: false
...
function createChainSwitchMiddleware({
  ...
  async function addNewChain(req, res) {
    ...
    if (!chainParams) throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.rpcErrors.invalidParams("Missing chain params");
    if (!chainParams.chainId) throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.rpcErrors.invalidParams("Missing chainId in chainParams");
    if (!chainParams.rpcUrls || chainParams.rpcUrls.length === 0) throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.rpcErrors.invalidParams("Missing rpcUrls in chainParams");
    if (!chainParams.nativeCurrency) throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.rpcErrors.invalidParams("Missing nativeCurrency in chainParams");
  ...
  async function updateChain(req, res) {
    ...
    if (!chainParams) throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.rpcErrors.invalidParams("Missing chainId");
    res.result = await switchChain(chainParams);
  }
  return (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createScaffoldMiddleware)({
    wallet_addEthereumChain: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createAsyncMiddleware)(addNewChain),
    wallet_switchEthereumChain: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createAsyncMiddleware)(updateChain)
  });
}
...
function createAccountMiddleware({
  ...
  async function updateAccount(req, res) {
    ...
    if (!(accountParams !== null && accountParams !== void 0 && accountParams.privateKey)) throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.rpcErrors.invalidParams("Missing privateKey");
    res.result = await updatePrivatekey(accountParams);
  }
  return (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createScaffoldMiddleware)({
    wallet_updateAccount: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createAsyncMiddleware)(updateAccount)
  });
}
...
/* harmony import */ var _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
...
function createJsonRpcClient(providerConfig) {
  ...
  const networkMiddleware = (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.mergeMiddleware)([createChainIdMiddleware(chainId), createProviderConfigMiddleware(providerConfig), fetchMiddleware]);
  return {
    networkMiddleware,
    fetchMiddleware
  };
...
function createWalletMiddleware({
  ...
  async function validateAndNormalizeKeyholder(address, req) {
    ...
    throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.rpcErrors.invalidParams({
  ...
  async function sendTransaction(req, res) {
    if (!processTransaction) {
      throw _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.rpcErrors.methodNotSupported();
    }
  ...
  return (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createScaffoldMiddleware)({
    // account lookups
    eth_accounts: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(lookupAccounts),
    eth_private_key: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(fetchPrivateKey),
    private_key: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(fetchPrivateKey),
    eth_coinbase: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(lookupDefaultAccount),
    // tx signatures
    eth_sendTransaction: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(sendTransaction),
    eth_signTransaction: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(signTransaction),
    // message signatures
    eth_sign: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(ethSign),
    eth_signTypedData: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(signTypedData),
    eth_signTypedData_v3: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(signTypedDataV3),
    eth_signTypedData_v4: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(signTypedDataV4),
    personal_sign: (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.createAsyncMiddleware)(personalSign)
  });
}
...
/* harmony export */   validateTypedMessageParams: () => (/* reexport safe */ _providers__WEBPACK_IMPORTED_MODULE_0__.SN)
/* harmony export */ });
/* harmony import */ var _providers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(280);
/* harmony import */ var _rpc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony reexport (unknown) */ var __WEBPACK_REEXPORT_OBJECT__ = {};
/* harmony reexport (unknown) */ for(const __WEBPACK_IMPORT_KEY__ in _rpc__WEBPACK_IMPORTED_MODULE_1__) if(["default","EIP1559APIEndpoint","EthereumPrivateKeyProvider","GAS_ESTIMATE_TYPES","LegacyGasAPIEndpoint","SignTypedDataVersion","TRANSACTION_ENVELOPE_TYPES","TRANSACTION_TYPES","TransactionFormatter","fetchEip1159GasEstimates","fetchLegacyGasPriceEstimates","getProviderHandlers","normalizeGWEIDecimalNumbers","validateTypedMessageParams"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = () => _rpc__WEBPACK_IMPORTED_MODULE_1__[__WEBPACK_IMPORT_KEY__]
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
