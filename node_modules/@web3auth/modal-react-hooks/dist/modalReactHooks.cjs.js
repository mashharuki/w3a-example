...
;// CONCATENATED MODULE: external "@web3auth/modal"
const modal_namespaceObject = require("@web3auth/modal");
;// CONCATENATED MODULE: external "react"
const external_react_namespaceObject = require("react");
;// CONCATENATED MODULE: ./src/context/Web3AuthInnerContext.ts
...
function Web3AuthInnerProvider(params) {
  ...
  const initModal = (0,external_react_namespaceObject.useCallback)(async (modalParams = {}) => {
    if (!web3Auth) throw base_namespaceObject.WalletInitializationError.notReady();
    try {
      setInitError(null);
...
;// CONCATENATED MODULE: ./src/hooks/useWeb3Auth.ts
...
;// CONCATENATED MODULE: ./src/Web3AuthProvider.ts
